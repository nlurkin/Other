...
The requirements for this interface have been defined with the help of R. Fantechi, G. Lamanna, M.
Sozzi and F. Varela Rodriguez. Thanks to them, J. Kunze, R. Lietava and V. Cerny for the initial
implementations. I would also like to thank S. Podolsky for his contribution with the link to the
offline database.
