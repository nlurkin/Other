...
(DAQ) chain. The integration work is already well advanced for some devices, for example the
main acquisition board TEL62\cite{biblio:TEL62}. In order to assure the most coherent system this
...
\begin{figure}
	...
	\begin{subfigure}{0.49\textwidth}
		\includegraphics[width=1.15\textwidth]{Doc/TEL62FSM.pdf}
		\caption{Generic FSM diagram for the devices.\newline}
		\label{fig:FSM_Device}
	\end{subfigure}
	\begin{subfigure}{0.49\textwidth}
		\includegraphics[width=1.15\textwidth]{Doc/NA62_EN.pdf}
